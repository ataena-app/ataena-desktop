...
Fase 3: Funcionalidades      [██░░░░░░░░░░░░░░░░░░]  10%
Fase 4: Distribución         [░░░░░░░░░░░░░░░░░░░░]   0%
─────────────────────────────────────────────────────────
Total del proyecto           [███████████░░░░░░░░░]  52%
```
...
| Infraestructura base | ⏳ Pendiente | | Instalar librerías, crear carpetas |
| Servidor HTTP local | ⏳ Pendiente | | Para recibir firmas desde móvil |
| Página web de firma (móvil) | ⏳ Pendiente | | HTML/JS para firma táctil |
| Generación de QR codes | ⏳ Pendiente | | Para conectar móvil con PC |
| Generación de PDFs | ⏳ Pendiente | | PDFs legalmente válidos |
| Integración en Clientes | ⏳ Pendiente | | RGPD e Imágenes |
| Integración en Trabajos | ⏳ Pendiente | | Consentimiento por trabajo |
| Vista de consentimientos | ⏳ Pendiente | | Lista y gestión |
| Gestión de consentimientos | ⏳ Pendiente | | CRUD completo |
| Almacenamiento de documentos | ⏳ Pendiente | | PDFs en carpeta local |
