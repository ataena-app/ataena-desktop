...
> **Estado general:** En desarrollo - Fase 4 en progreso (~90% del proyecto)  
> **Nombre del proyecto:** Ataena (renombrado desde InkStudio)
...
> 📋 **Estado actual:** Ver `ESTADO-ACTUAL.md` para resumen ejecutivo de lo hecho y lo pendiente.  
> 🔐 **Licencias y actualizaciones:** Ver `07-plan-licencias-actualizaciones.md` para el plan y checklist.
...
| Escáner e Impresora | ✅ Completado | Mar 2026 | Escanear DNI con WIA, imprimir consentimientos PDF |
...
| Almacenamiento de documentos | ✅ Completado | Dic 2025 | PDFs en %LOCALAPPDATA%\Ataena\ficheros\clientes\{id}\consentimientos\ |
...
| Escaneo de DNI | ✅ Completado | Mar 2026 | EscannerService con WIA, botón en FotoDniView |
| Impresión de consentimientos | ✅ Completado | Mar 2026 | ImpresorService, botón Imprimir tras generar PDF |
...
- ✅ **InkStudio → Ataena:** Renombrado completo en código, documentación y estructura
  - Namespaces, DbContext, rutas (%LOCALAPPDATA%\Ataena\), logs (ataena-*.log)
  - Carpeta del proyecto, .csproj, AssemblyName
  - Documentación actualizada en todos los archivos

**Hardware (Configuración):**
- ✅ **Escáner:** EscannerService con WIA (Windows Image Acquisition)
  - Escaneo de DNI desde FotoDniView cuando UsarEscanner está activado
  - Toggle en Configuración
- ✅ **Impresora:** ImpresorService para imprimir PDFs
  - Botón Imprimir en ConsentimientoFirmaView tras generar PDF
  - Toggle en Configuración
...
4. [x] ~~Escáner e Impresora~~ ✅ Completado
5. [x] ~~Renombrar InkStudio a Ataena~~ ✅ Completado
6. [ ] **Crear instalador de la aplicación** ← Siguiente prioridad
7. [ ] Icono de aplicación profesional
8. [ ] Testing manual completo antes de distribución
9. [ ] Implementar tema claro/oscuro (diferido)
10. [ ] Implementar seguridad (login, cifrado de BD)

---

## 🗺️ Ruta Completa - Lo que queda

### Prioridad Alta (para distribuir)
| # | Tarea | Fase | Esfuerzo | Notas |
|---|-------|------|----------|-------|
| 1 | Crear instalador (Inno Setup o Velopack) | 4 | Alto | Ver `04-plan-distribucion.md` |
| 2 | Icono de aplicación profesional | 4 | Bajo | Sustituir avalonia-logo.ico |
| 3 | Testing manual completo | 4 | Medio | Probar todos los flujos antes de v1.0 |

### Prioridad Media (pulido)
| # | Tarea | Fase | Esfuerzo |
|---|-------|------|----------|
...
### Estado actual del código (Feb 2026)
- **Stack:** .NET 9, Avalonia 11.3.9, EF Core 9, QuestPDF 2025.12
- **Ruta de datos:** `%LOCALAPPDATA%\Ataena\` (data.db, logs, ficheros)
- **Ejecutable:** Ataena.exe (AssemblyName configurado)
