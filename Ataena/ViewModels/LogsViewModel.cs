...
public partial class LogsViewModel : ViewModelBase
{
    ...
    private void CargarArchivosLog()
    {
        try
        {
            ...
            var archivos = Directory.GetFiles(LoggingService.LogsFolder, "ataena-*.log")
    ...
    private async Task CopiarLog()
    {
        try
        {
            ...
            var tempFile = Path.Combine(Path.GetTempPath(), $"ataena-log-{DateTime.Now:yyyyMMddHHmmss}.txt");
    ...
    private Task ExportarLog()
    {
        ...
        try
        {
            ...
            var nombreArchivo = $"ataena-log-export-{DateTime.Now:yyyyMMddHHmmss}.txt";
